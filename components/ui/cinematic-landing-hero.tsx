...
export function CinematicHero({
  ...
  tagline2 = "one project at a time.",
  cardHeading = "Innovation, delivered.",
  cardDescription = <><span className="text-white font-semibold">TechCo</span> delivers cutting-edge AI and full-stack development solutions that transform ideas into reality.</>,
  metricValue = 100,
  metricLabel = "Projects Delivered",
  ctaHeading = "Ready to innovate?",
  ctaDescription = "Join industry leaders who trust us with their most ambitious projects.",
  className,
  ...props
}: CinematicHeroProps) {
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                  ...
                  <div className="absolute inset-[7px] bg-[#050914] rounded-[2.5rem] overflow-hidden shadow-[inset_0_0_15px_rgba(0,0,0,1)] text-white z-10">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        ...
                        <div className="w-9 h-9 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-sm border border-white/10 shadow-lg shadow-black/50">TC</div>
                      </div>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Rapid Deployment</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Always on time</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Precision Engineering</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Quality guaranteed</p>
                  </div>
                </div>
