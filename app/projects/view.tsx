...
export default function ProjectsView({ initialProjects }: { initialProjects: ApiProject[] | null }) {
  const [filter, setFilter] = useState<typeof FILTERS[number]>("All");
  const { data: projects } = usePublicAPI(getPublicProjects, PROJECTS as unknown as ApiProject[], initialProjects);
