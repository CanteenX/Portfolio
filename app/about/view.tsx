...
export default function AboutView({ initialSettings }: { initialSettings: PortfolioSettings | null }) {
        ...
        <section className="py-24 px-6">
          <div className="max-w-7xl mx-auto">
            <ScrollReveal direction="up">
              <div className="mb-16">
                <div className="text-mono-tag text-mint mb-3">Protocol // Core Values</div>
                <h2 className="tracking-tight lowercase">Principles that drive us.</h2>
              </div>
            </ScrollReveal>
